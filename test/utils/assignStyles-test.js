import assignStyles from '../../modules/utils/assignStyles'

describe('assignStylesing objects', () => {
  it('should merge properties', () => {
    expect(assignStyles({ color: 'red' }, { fontSize: 12 }, { lineHeight: 1 })).to.eql({
      color: 'red',
      fontSize: 12,
      lineHeight: 1
    })
  ...
  it('should overwrite properties from right to left', () => {
    expect(assignStyles({ fontSize: 12 }, { fontSize: 16 }, { fontSize: 11 })).to.eql({ fontSize: 11 })
  })
