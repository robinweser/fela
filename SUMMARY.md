...
* [4. Usage Guides](docs/UsageGuides.md)
  ...
  * [4.6. Usage with Cycle](docs/guides/UsageWithCycle.md)
...
* [6. API Reference](docs/API.md)
  ...
  * 6.4. react/preact/inferno
    * [6.4.1 connect](docs/api/bindings/connect.md)
    * [6.4.2 createComponent](docs/api/bindings/createComponent.md)
    * [6.4.3 createComponentWithProxy](docs/api/bindings/createComponentWithProxy.md)
    * [6.4.4 FelaComponent](docs/api/bindings/FelaComponent.md)
    * [6.4.5 FelaTheme](docs/api/bindings/FelaTheme.md)
    * [6.4.6 Provider](docs/api/bindings/Provider.md)
    * [6.4.7 ThemeProvider](docs/api/bindings/ThemeProvider.md)
    * [6.4.8 withTheme](docs/api/bindings/withTheme.md)
