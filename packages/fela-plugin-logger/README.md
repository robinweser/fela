...
<script src="https://unpkg.com/fela-plugin-logger@4.2.1/dist/fela-plugin-logger.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-plugin-logger@4.2.1/dist/fela-plugin-logger.min.js"></script>
```
