...
<script src="https://unpkg.com/fela-plugin-logger@3.0.7/dist/fela-plugin-logger.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-plugin-logger@3.0.7/dist/fela-plugin-logger.min.js"></script>
```
