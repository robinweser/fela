...
<script src="https://unpkg.com/fela-plugin-logger@2.0.0/dist/fela-plugin-logger.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-plugin-logger@2.0.0/dist/fela-plugin-logger.min.js"></script>
```
