...
<script src="https://unpkg.com/fela-plugin-extend@4.3.1/dist/fela-plugin-extend.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-plugin-extend@4.3.1/dist/fela-plugin-extend.min.js"></script>
```
