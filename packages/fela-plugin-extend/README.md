...
<script src="https://unpkg.com/fela-plugin-extend@3.0.5/dist/fela-plugin-extend.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-plugin-extend@3.0.5/dist/fela-plugin-extend.min.js"></script>
```
