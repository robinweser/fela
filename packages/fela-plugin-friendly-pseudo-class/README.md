...
<script src="https://unpkg.com/fela-plugin-friendly-pseudo-class@1.2.0/dist/fela-plugin-friendly-pseudo-class.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-plugin-friendly-pseudo-class@1.2.0/dist/fela-plugin-friendly-pseudo-class.min.js"></script>
```
