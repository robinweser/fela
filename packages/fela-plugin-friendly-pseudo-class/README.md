...
<script src="https://npmcdn.com/fela-plugin-friendly-pseudo-class@1.0.1/dist/fela-plugin-friendly-pseudo-class.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://npmcdn.com/fela-plugin-friendly-pseudo-class@1.0.1/dist/fela-plugin-friendly-pseudo-class.min.js"></script>
```
