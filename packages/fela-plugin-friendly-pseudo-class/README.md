...
<script src="https://unpkg.com/fela-plugin-friendly-pseudo-class@3.0.5/dist/fela-plugin-friendly-pseudo-class.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-plugin-friendly-pseudo-class@3.0.5/dist/fela-plugin-friendly-pseudo-class.min.js"></script>
```
