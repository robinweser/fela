...
<script src="https://npmcdn.com/fela-plugin-custom-property@1.0.1/dist/fela-plugin-custom-property.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://npmcdn.com/fela-plugin-custom-property@1.0.1/dist/fela-plugin-custom-property.min.js"></script>
```
