...
<script src="https://unpkg.com/fela-plugin-prefixer@3.0.3/dist/fela-plugin-prefixer.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-plugin-prefixer@3.0.3/dist/fela-plugin-prefixer.min.js"></script>
```
