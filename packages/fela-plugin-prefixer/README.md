...
<script src="https://unpkg.com/fela-plugin-prefixer@4.3.1/dist/fela-plugin-prefixer.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-plugin-prefixer@4.3.1/dist/fela-plugin-prefixer.min.js"></script>
```
