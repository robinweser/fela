...
<script src="https://unpkg.com/fela-plugin-lvha@3.0.6/dist/fela-plugin-lvha.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-plugin-lvha@3.0.6/dist/fela-plugin-lvha.min.js"></script>
```
