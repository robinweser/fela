...
module Fela = {
  ...
  module Dom = {
    ...
    [@bs.module "fela-dom"]
    external renderToSheetList: renderer => array(sheet) =
      "renderToSheetList";
  };

  module Plugins = {
    // TODO: more type-safe input (rtl and ltr)
    [@bs.module "fela-plugin-bidi"]
    external bidi: string => plugin = "default";
...
module ReactFela = {
  ...
  module ThemeProvider = {
    [@bs.module "react-fela"] [@react.component]
    external make:
      (~theme: Js.t('a), ~children: React.element) => React.element =
      "ThemeProvider";
  };
};