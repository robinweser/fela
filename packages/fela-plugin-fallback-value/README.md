...
<script src="https://unpkg.com/fela-plugin-fallback-value@3.0.2/dist/fela-plugin-fallback-value.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-plugin-fallback-value@3.0.2/dist/fela-plugin-fallback-value.min.js"></script>
```
