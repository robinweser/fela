...
<script src="https://unpkg.com/fela-plugin-fallback-value@4.3.4/dist/fela-plugin-fallback-value.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-plugin-fallback-value@4.3.4/dist/fela-plugin-fallback-value.min.js"></script>
```
