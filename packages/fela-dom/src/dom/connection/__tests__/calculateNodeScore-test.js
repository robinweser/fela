import calculateNodeScore from '../calculateNodeScore-test'
...
describe('Calculating the node score', () => {
  ...
  it('should return 4', () => {
    expect(
      calculateNodeScore([], { type: 'RULE_TYPE', support: true })
    ).toEqual(4)
  })
  it('should return 5', () => {
    expect(
      calculateNodeScore(['min-width: 300px'], {
        type: 'RULE_TYPE',
  ...
  it('should return 9', () => {
    expect(
      calculateNodeScore(
        ['min-width: 300px', 'min-width: 400px', 'min-width: 500px'],

        { type: 'RULE_TYPE', media: 'min-width: 500px' }
      )
    ).toEqual(9)
  })
