...
<script src="https://unpkg.com/fela-preset-dev@1.2.0/dist/fela-preset-dev.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-preset-dev@1.2.0/dist/fela-preset-dev.min.js"></script>
```
