...
<script src="https://unpkg.com/fela-preset-dev@3.0.4/dist/fela-preset-dev.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-preset-dev@3.0.4/dist/fela-preset-dev.min.js"></script>
```
