...
<script src="https://unpkg.com/fela-preset-dev@4.0.1/dist/fela-preset-dev.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-preset-dev@4.0.1/dist/fela-preset-dev.min.js"></script>
```
