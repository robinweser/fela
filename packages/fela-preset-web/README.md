...
<script src="https://unpkg.com/fela-preset-web@2.0.0/dist/fela-preset-web.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-preset-web@2.0.0/dist/fela-preset-web.min.js"></script>
```
