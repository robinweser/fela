...
<script src="https://unpkg.com/fela-preset-web@4.3.3/dist/fela-preset-web.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-preset-web@4.3.3/dist/fela-preset-web.min.js"></script>
```
