...
<script src="https://unpkg.com/fela-preset-web@3.0.6/dist/fela-preset-web.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-preset-web@3.0.6/dist/fela-preset-web.min.js"></script>
```
