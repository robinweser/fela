...
<script src="https://unpkg.com/fela-plugin-named-media-query@4.2.0/dist/fela-plugin-named-media-query.js"></script>
<!-- Fela (Production): Minified version -->
<script src="https://unpkg.com/fela-plugin-named-media-query@4.2.0/dist/fela-plugin-named-media-query.min.js"></script>
```
