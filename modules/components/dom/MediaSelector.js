...
export default class MediaSelector extends Selector {
  ...
  constructor(composer, mediaComposer = { }) {
    ...
    warning(Object.keys(mediaComposer).length > 0, 'You are using a MediaSelector without specifying at least one media style composer. Prefer using basic Selectors instead.')
  }
