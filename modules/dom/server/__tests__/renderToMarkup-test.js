...
describe('Rendering to HTML markup', () => {
  it('should return a single HTML markup string', () => {
    ...
    const staticStyle = '<style type="text/css" data-fela-type="STATIC">*{box-sizing:border-box}div{display:flex}</style>'
    const ruleStyle = '<style type="text/css" data-fela-type="RULE">.a{color:red}</style>'
    const mediaRuleStyle = '<style type="text/css" data-fela-type="RULE" media="(min-height: 300px)">.b{color:blue}</style>'
