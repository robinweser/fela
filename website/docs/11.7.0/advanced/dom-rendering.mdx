...
Most bindings such as [react-fela](https://github.com/robinweser/fela/tree/master/packages/react-fela) and [vue-fela](https://github.com/wagerfield/vue-fela) will automatically do that for you.
