...
Despite many benefical [side effects](intro/benefits), Fela actually only has three major goals.

1. Make styling **dynamic by default**
2. Be **framework-agnostic**, that is being used with any view library
3. Be **high performant**

Read about the [principles](intro/principles) to understand how and why Fela is dynamic by default.
