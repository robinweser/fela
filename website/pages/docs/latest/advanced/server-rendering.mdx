...
All you need to do is call [`renderToMarkup`](api/fela-dom/renderToMarkup) or, depending on your scenario, [`renderToSheetList`](api/fela-dom/renderToSheetList) once you are finished rendering styles and you will get the final HTML markup for the `<style>` elements.<br />
