...
| -------- | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| config   | _Object?_ | Optional renderer configuration. The most common use case is adding [plugins](advanced/plugins) to process styles before they get cached.<br />_See [Advanced - Renderer Configuration](../../advanced/RendererConfiguration.md) for further information_ |
