...
| -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| style    | [_Rule_](../../basics/Rules.md)<br />[_StyleObject_](../../basics/Rules.md#styleobject)<br />_Array_[[_Rule_](../../basics/Rules.md), [_StyleObject_](../../basics/Rules.md#styleobject)] |         | Either a valid style object, and [rule](../../basics/Rules.md) or an array of both                                                                          |
