...
| -------- | -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| css      | _function_                             | A function that accepts a list of [style object](../basics/Rules.md#styleobject) and/or [rule](../basics/Rules.md) and returns a single className. |
| theme    | _Object_                               | The theme object which is passed down via context                                                                                                  |
| renderer | _[Renderer](../../basics/Renderer.md)_ | The renderer that is passed down via context                                                                                                       |
