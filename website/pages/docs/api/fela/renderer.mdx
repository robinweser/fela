...
| -------- | ---------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| rule     | _Function_ |         | A function which satisfies the [rule](../../basics/Rules.md) behavior.<br />It **must** return a valid [style object](../../basics/Rules.md#styleobject). |
...
| Argument | Type       | Default | Description                                                                                                                                                                 |
| -------- | ---------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| keyframe | _Function_ |         | A function which satisfies the [keyframe](../../basics/Keyframes.md) behavior.<br />It **must** return a valid [keyframe object](../../basics/Keyframes.md#keyframeobject). |
