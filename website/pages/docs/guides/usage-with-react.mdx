...
It accepts a single property _style_ that accepts a style object, style function or array of both.
...
FelaComponent renders a _div_ by default, but we can pass an **as** prop to configure the rendered element.<br />
