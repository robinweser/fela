...
| ------------------- | ------------- | --------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| plugins             | _(Array?)_    |                                   | A list of [plugins](../advanced/Plugins.md) to process styles before rendering                                                                                                                      |
| keyframePrefixes    | _(Array?)_    | `['-webkit-', '-moz-']`           | A list of which additional `@keyframes` prefixes are rendered                                                                                                                                       |
| enhancers           | _(Array?)_    |                                   | A list of [enhancers](../advanced/Enhancers.md) to enhance the renderer                                                                                                                             |
